...
const listDisplayContainer = document.querySelector(`[data-list-display-container]`);//todo-list
...
function render() {
    ...
    const selectedList = lists.find(list => list.id === selectedListId);
    if(selectedListId == null || selectedList === undefined) { //I added a undefined option here to avoid show a empty box
